...
Heu de donar a totes les opcions, un rang entre 1 i 999.',
	...
	'securepoll-not-logged-in' => "Heu d'estar [[Special:Userlogin|connectats]] per a votar en aquesta elecció. Si encara no teniu cap compte, podeu [[Special:Userlogin/signup|crea una]].",
...
شما باید به همهٔ گزینه‌ها امتیازی بین ۱ تا ۹۹۹ بدهید.',
	...
	'securepoll-not-logged-in' => 'شما باید برای رأی دادن در این رای‌گیری [[Special:Userlogin|وارد سامانه شوید]]. اگر هنوز حساب کاربر ندارید، می‌توانید  [[Special:Userlogin/signup|یک حساب کاربری بسازید]].',
...
Du muesch allene Optione e Rangnummere zwische 1 un 999 gee.',
	...
	'securepoll-not-logged-in' => 'Du muesch [[Special:Userlogin|aagmäldet]] syy go bi däre Wahl abstimme z chenne. Wänn Du no kei Benutzerkonto hesch, chasch eis [[Special:Userlogin/signup|aalege]].',
...
Tu debe dar a tote le optiones un rango inter 1 e 999.',
	...
	'securepoll-not-logged-in' => 'Es necessari [[Special:Userlogin|aperir un session]] pro votar in iste election. Si tu non ha ancora un conto, tu pote [[Special:Userlogin/signup|crear un]].',
...
It deuve deje a minca vos un vot tra 1 e 999.',
	...
	'securepoll-not-logged-in' => "A dev [[Special:Userlogin|intré ant ël sistema]] për voté për costa elession. S' l'ha anco' pa un cont, a peul [[Special:Userlogin/signup|creene un]].",
...
Мусите вшыткым можностям задати місце міджі 1 і 999.',
	...
	'securepoll-not-logged-in' => 'Жебы сьте міг(могла) голосовати, мусите ся [[Special:Userlogin|приголосити]]. Кідь іщі не мате конто, можете  [[Special:Userlogin/signup|собі створити]].',
