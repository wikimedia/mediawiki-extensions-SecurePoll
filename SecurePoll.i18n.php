...
Jy moet alle opsies om 'n rang tussen 1 en 999.",
	...
	'securepoll-api-token-mismatch' => 'Sekuriteit-token kom nie ooreen met wat verwag word nie.
Dis nie moontlik om aan te meld nie.',
...
يجب أن تعطي كل الخيارات رتبة ما بين 1 و 999.',
	...
	'securepoll-strike-cancel' => 'إلغاء',
...
$messages['as'] = array(
	...
	'securepoll-invalid-election' => '"$1" বৈধ নিৰ্বাচন আইডি নহয়।',
	'securepoll-welcome' => '<strong>আদৰিছোঁ $1!</strong>',
...
আপুনি সকলো বিকল্পকে ১ আৰু ৯৯৯ৰ মাজত এটা ৰেংক দিব লাগিব।',
	...
	'securepoll-too-few-edits' => 'দুঃখিত, আপুনি ভোট দিব নোৱাৰে। ভোট দিবৰ বাবে আপুনি $1টা {{PLURAL:$1|সম্পাদনা|সম্পাদনা}} কৰাৰ প্ৰয়োজন, কিন্তু $2টাহে আপোনাৰ হৈছে।',
	'securepoll-too-new' => 'ক্ষমা কৰিব, আপুনি ভোট দিব নোৱাৰে। ভোটদানৰ বাবে আপোনাৰ একাউণ্টটো $1 তাৰিখৰ $3 সময়ৰ আগতে পঞ্জীয়ন কৰা প্ৰয়োজনীয় আছিল, আপুনি $2 তাৰিখৰ $4 সময়ত পঞ্জীয়ন কৰিছে।',
	'securepoll-blocked' => 'দুঃখিত, আপুনি বৰ্তমান সম্পাদনাৰ পৰা বাধা দিয়া অৱস্থাত আছে, সেয়ে আপুনি এই নিৰ্বাচনত ভোট প্ৰদান কৰিব মোৱাৰে।',
	'securepoll-blocked-centrally' => 'ক্ষমা কৰিব, আপুনি এই নিৰ্বাচনত ভোটদান কৰিব নোৱাৰে কাৰণ অন্ততঃ $1 {{PLURAL:$1|টা ৱিকিত|টা ৱিকিত}} আপোনাক অৱৰোধ কৰা হৈছে।',
	...
	'securepoll-not-in-list' => 'ক্ষমা কৰিব, এই নিৰ্বাচনত ভোট দিবলৈ সক্ষম সদস্যৰ পূৰ্ব গঠিত তালিকাত আপোনাৰ নাম নাই।',
	'securepoll-list-title' => 'ভোটৰ তালিকা: $1',
	'securepoll-header-timestamp' => 'সময়',
	'securepoll-header-voter-name' => 'নাম',
	'securepoll-header-voter-domain' => 'ডমেইন',
	'securepoll-header-ip' => 'আই-পি',
	'securepoll-header-ua' => 'ব্যৱহাৰকাৰী এজেণ্ট',
	'securepoll-header-cookie-dup' => 'ডাপ',
	'securepoll-header-strike' => 'ষ্ট্ৰাইক',
	'securepoll-header-details' => 'বিস্তাৰিত',
	'securepoll-strike-button' => 'ষ্ট্ৰাইক',
	'securepoll-unstrike-button' => 'আনষ্ট্ৰাইক',
	'securepoll-strike-reason' => 'কাৰণ:',
	'securepoll-strike-cancel' => 'বাতিল কৰক',
	'securepoll-strike-error' => 'ষ্ট্ৰাইক/আনষ্ট্ৰাইক কৰোঁতে ত্ৰুটী হৈছে: $1',
	'securepoll-strike-token-mismatch' => 'চেছন ডেটা হেৰাই গৈছে',
	'securepoll-details-link' => 'বিস্তাৰিত',
	'securepoll-details-title' => 'ভোটৰ বিৱৰণ: #$1',
	'securepoll-invalid-vote' => '"$1" বৈধ ভোট আইডি নহয়',
	'securepoll-header-id' => 'আই-ডি',
	'securepoll-header-voter-type' => 'ভোটাৰৰ প্ৰকাৰ',
	'securepoll-header-url' => 'ইউআৰএল',
	'securepoll-voter-properties' => 'ভোটাৰৰ তথ্যাদি',
	'securepoll-strike-log' => "ষ্ট্ৰাইক ল'গ",
	'securepoll-header-action' => 'কাৰ্য',
	'securepoll-header-reason' => 'কাৰণ',
	'securepoll-header-admin' => 'প্ৰশাসক',
	'securepoll-cookie-dup-list' => 'প্ৰতিলিপি ব্যৱহাৰকাৰীৰ কুকি',
	'securepoll-dump-title' => 'ডাম্প: $1',
	'securepoll-dump-no-crypt' => 'এই নিৰ্বাচনৰ বাবে কোনো গোপন সংকেতযুক্ত নিৰ্বাচন নথি উপলব্ধ নহয়, কাৰণ নিৰ্বাচনটো সংকেত ব্যৱহাৰ কৰিবলৈ কন্‌ফিগাৰ কৰিবলৈ কৰা হোৱা নাই।',
	'securepoll-dump-not-finished' => "শেষ তাৰিখ $1ৰ $2 সময়ৰ পিছতহে গোপন সংকেতযুক্ত নিৰ্বাচন নথি উপলব্ধ হ'ব।",
	'securepoll-dump-no-urandom' => "/dev/urandom খুলিব নোৱাৰি।
ভোটাৰৰ গোপনীয়তা অক্ষত ৰাখিবলৈ সংকেতযুক্ত নিৰ্বাচন নথি তেতিয়াহে ৰাজহুৱাকৈ উপলব্ধ হ'ব যেতিয়া সেইবোৰ এটা সুৰক্ষিত যাদৃচ্ছিক সংখ্যা ষ্ট্ৰীমৰ লগত সলনাসলনি কৰিব পৰা হ'ব।",
	'securepoll-urandom-not-supported' => "এই চাৰ্ভাৰে সংকেতযুক্ত যাদৃচ্ছিক সংখ্যাৰ উৎপত্তি সমৰ্থন নকৰে।
ভোটাৰৰ গোপনীয়তা অক্ষত ৰাখিবলৈ সংকেতযুক্ত নিৰ্বাচন নথি তেতিয়াহে ৰাজহুৱাকৈ উপলব্ধ হ'ব যেতিয়া সেইবোৰ এটা সুৰক্ষিত যাদৃচ্ছিক সংখ্যা ষ্ট্ৰীমৰ লগত সলনাসলনি কৰিব পৰা হ'ব।",
	'securepoll-translate-title' => 'অনুবাদ: $1',
	'securepoll-invalid-language' => 'অপ্ৰযোজ্য ভাষা কোড "$1"',
	'securepoll-header-trans-id' => 'আই-ডি',
	'securepoll-submit-translate' => 'আপডেট',
	'securepoll-language-label' => 'ভাষা নির্বাচন:',
	'securepoll-submit-select-lang' => 'অনুবাদ কৰক',
	'securepoll-entry-text' => 'তলত ভোটৰ তালিকা প্ৰদান কৰা হৈছে।',
	'securepoll-header-title' => 'নাম',
	'securepoll-header-start-date' => 'আৰম্ভ কৰা তাৰিখ',
	'securepoll-header-end-date' => 'শেষ কৰা তাৰিখ',
	...
	'securepoll-subpage-tally' => 'হিচাপ',
	'securepoll-tally-title' => 'হিচাপ: $1',
	'securepoll-tally-not-finished' => 'ক্ষমা কৰিব, ভোটদান সমাপ্ত নোহোৱালৈকে আপুনি নিৰ্বাচনৰ ভোট গণনা কৰিব নোৱাৰে।',
	'securepoll-can-decrypt' => "নিৰ্বাচনৰ নথি সাংকেতিক কৰি পেলোৱা হৈছে, কিন্তু তাক মুকলি কৰা চাবি আছে।
আপুনি তথ্যকোষত থকা ফলাফল গণনা কৰিব পাৰে, বা এটা আপল'ড কৰা ফাইলৰ পৰা সাংকেতিক ফলাফল গণনা কৰিব পাৰে।",
	'securepoll-tally-no-key' => 'আপুনি এই নিৰ্বাচনৰ ফলাফল গণনা কৰিব নোৱাৰে, কাৰণ ভোটসমূহ সাংকেতিক কৰি পেলোৱা হৈছে আৰু সংকেতৰ চাবি উপলব্ধ নহয়।',
	'securepoll-tally-local-legend' => 'সংৰক্ষণ কৰা ফলাফল হিচাপ কৰক',
	'securepoll-tally-local-submit' => 'হিচাপ তৈয়াৰ কৰক',
	'securepoll-tally-upload-legend' => "এন্‌ক্ৰীপ্ট ডাম্প আপল'ড কৰক",
	'securepoll-tally-upload-submit' => 'হিচাপ তৈয়াৰ কৰক',
	...
	'securepoll-spoilt' => "(বেয়া হ'ল)",
	'securepoll-exhausted' => "(শেষ হ'ল)",
);
...
Шифрҙы уҡыу мөмкин түгел.',
	...
	'securepoll-too-few-edits' => 'Ғәфү итегеҙ, һеҙ тауыш бирә алмайһығыҙ. Һеҙгә был һайлауҙарҙа ҡатнашыу өсөн, кәмендә $1 {{PLURAL:$1|үҙгәртеү}} яһарға кәрәк, һеҙ $2 үҙгәртеү эшләгәнһегеҙ.', # Fuzzy
...
Ika kaipuhang magtao sa gabos na mga pagpipilian nin sarong ranggo sa katahawan kan 1 asin 999.',
	...
	'securepoll-cookie-dup-list' => 'Mga paragamit kan panduwahang kokie',
	'securepoll-dump-title' => 'Ibasura: $1',
	'securepoll-dump-no-crypt' => 'Mayong enkriptadong rekord kan eleksyon an makukua para sa eleksyong ini, nin huli ta an eleksyon dae pinagsunsay na gumamit nin enkripsyon.',
	'securepoll-dump-not-finished' => 'An enkriptadong mga rekord kan eleksyon manunumpungan sana pagkatapos kan petsa $1 mga alas $2',
	'securepoll-dump-no-urandom' => 'Dae makakabukas/dev/urandom.
Tanganing mantineron an pribasidad kan botante, an mga enkriptadong rekord kan eleksyon manunumpungan sana kan publiko kunsoarin sinda mapuwedeng maibalasa nin sarong segurong bulos kan purak nin numero.',
	'securepoll-urandom-not-supported' => 'Ining serbidor dae makakasuporta nin kriptograpikong henerasyon kan purak na numero.
Tanganing mantineron an pribasidad kan botante, an mga enkriptadong rekord kan eleksyon manunumpungan sana kan publiko kunsoarin sinda mapuwedeng maibalasa nin sarong segurong bulos kan purak nin numero.',
	'securepoll-translate-title' => 'Idakit-taramon: $1',
	'securepoll-invalid-language' => 'Imbalidong kodigo kan lengguwahe "$1"',
	'securepoll-submit-translate' => 'Panumpay',
	'securepoll-language-label' => 'Pilion an lengguwahe:',
	'securepoll-submit-select-lang' => 'Idakit-taramon',
	'securepoll-entry-text' => 'Yaon sa ibaba an listahan kan mga pagboboto.',
	'securepoll-header-title' => 'Pangaran',
	'securepoll-header-start-date' => 'Petsa kan pagpoon',
	'securepoll-header-end-date' => 'Petsa kan pagtapos',
	'securepoll-subpage-vote' => 'Bumoto',
	'securepoll-subpage-translate' => 'Idakit-taramon',
	'securepoll-subpage-list' => 'Listahan',
	'securepoll-subpage-dump' => 'Ibasura',
	'securepoll-subpage-tally' => 'Ikurit',
	'securepoll-tally-title' => 'An kurit: $1',
	'securepoll-tally-not-finished' => 'Sori po, ika dae makakakurit sa eleksyon sagkod na matapos an borotohan nakumpleto na.',
	'securepoll-can-decrypt' => 'An rekord kan eleksyon enkriptado na, alagad an susi kan dekripsyon yaon.
   Ika makakapili sa arinman na kurit kan presenteng mga resulta na yaon sa datos-sarayan, o tanganing ikurit an enkriptadong mga resulta gikan sa sarong ipinagkargang sagunson.',
	'securepoll-tally-no-key' => 'Ika dae makakakurit kaining eleksyon, nin huli ta an mga boto magin enkriptado, asin an susi kan dekripsyon dae manunumpungan.',
	'securepoll-tally-local-legend' => 'Ikurit an pinagsaray na mga resulta',
	'securepoll-tally-local-submit' => 'Muknaon an kurit',
	'securepoll-tally-upload-legend' => 'Ikarga an enkriptadong basura',
	'securepoll-tally-upload-submit' => 'Muknaon an kurit',
	'securepoll-tally-error' => 'Kasalaan sa pag-interpretar kan rekord nin boto, dae makapagprodyuser nin sarong kurit.',
...
На всяка от опциите трябва да поставите ранг цяло число между 1 и 999.',
	...
	'securepoll-too-new' => 'За съжаление, не можете да гласувате.  Вашата потребителска сметка е регистрирана на $2, а е трябвало да бъде регистрирана преди $1, за да имате право на глас.', # Fuzzy
...
আপনাকে অবশ্যই সকল অপশন ১ থেকে ৯৯৯-এর মধ্যে র্যাংকিং করতে হবে।',
	...
	'securepoll-too-new' => 'দুঃখিত আপনি ভোট দিতে পারবেন না। এই নির্বাচনে ভোট দেয়ার জন্য আপনাকে $3 এ $1 এর আগে নিবন্ধন করতে হতো, আপনি নিবন্ধন করেছেন $2 এর $4।',
	...
	'securepoll-blocked-centrally' => 'দুঃখিত আপনি ভোট দিতে পারবেন না আপনাকে অন্তত $1টি {{PLURAL:$1|উইকিতে|উইকিতে}} ব্লক করা হয়েছে।',
	...
	'securepoll-dump-title' => 'ডাম্প: $1',
	'securepoll-dump-no-crypt' => 'এই নির্বাচনের জন্য কোনো এনক্রিপটেড নির্বাচন পদ্ধতি পাওয়া যায়নি, কারণ এই নির্বাচনের জন্য কোনো এনক্রিপশন পদ্ধতি নির্বাচন করা হয়নি।',
	'securepoll-dump-not-finished' => 'এনক্রিপটেড নির্বাচনের ফলাফল জানতে পারা যাবে কেবলমাত্র $1 তারিখের $2 এর পর',
	'securepoll-translate-title' => 'অনুবাদ: $1',
	...
	'securepoll-subpage-vote' => 'ভোট',
	'securepoll-subpage-translate' => 'অনুবাদ',
	'securepoll-subpage-list' => 'তালিকা',
	'securepoll-subpage-dump' => 'ডাম্প',
...
Morate dati svim opcijama rang između 1 i 999.',
	...
	'securepoll-too-new' => 'Žao nam je, ne možete glasati.  Vaš račun treba biti registrovan prije $1 da biste glasali na ovim izborima, vi ste registrovani dana $2.', # Fuzzy
	'securepoll-blocked' => 'Žao nam je, ne možete trenutno glasati na ovim izborima ako ste trenutno blokirani za uređivanje.',
	'securepoll-blocked-centrally' => 'Žao nam je, vi ne možete glasati na ovim izborima ako ste blokirani na $1 ili više {{PLURAL:$1|wikija|wikija}}.', # Fuzzy
...
heme tercihan re gani şıma benateyê 1 u 999  de yew derece bıdi.',
	...
	'securepoll-too-new' => 'Kısur mewni rê, şıma nêşenê rey bıdê. Ena weçinen dê qandê ray dayışi hesabê qeyd kerdışê şıma do verdê tarix da $1 $3 qeyd kerdış icab keno. Şıma $2 $4 dı biyê qeyd.',
	'securepoll-blocked' => 'Üma meluli, eke şıma bloke biyi şıma nêşkeni rey bıdi.',
	'securepoll-blocked-centrally' => 'Malesef, tewr tayn $1 {{PLURAL:$1|wiki|Wikiyan}} de şıma bloqe biye se, ena weçinayen de şıma nêşenê rey bıdê.',
	'securepoll-bot' => 'Kısur mewni rê, hesabê ke bot deye nışan biyê ê nêşenê na weçinen de rey bıdê.',
	...
	'securepoll-header-ip' => 'IP',
	'securepoll-header-xff' => 'XFF',
	'securepoll-header-ua' => 'Temsilkarê karberi',
	'securepoll-header-token-match' => 'CSRF',
	...
	'securepoll-strike-cancel' => 'Bıtexelne',
	'securepoll-strike-error' => 'serê ey de xeta bıanc/meanc ardene ca  xeta da: $1',
	'securepoll-strike-token-mismatch' => 'Melumatê hesabi biyo vindi',
	...
	'securepoll-header-action' => 'Kerdış',
	'securepoll-header-reason' => 'Sebeb',
...
qey idame kerdışi pinaniyê reydayoxi, eke pawıte bo a beno.',
	...
	'securepoll-submit-translate' => 'Noroc resn',
	...
	'securepoll-ranks' => 'Rêzkerdışo peyên',
...
Debes clasificar a todas las opciones con un rango entre 1 y 999.',
	...
	'securepoll-blocked-centrally' => 'Lo sentimos, no puede votar en esta elección pues usted está bloqueado en al menos $1 {{PLURAL:$1|wiki|wikis}}.',
...
Pead kõigile valitavatele andma 1 ja 999 vahele jääva järjekorranumbri.',
	...
	'securepoll-not-logged-in' => 'Pead sisse logima, et sellel valimisel osaleda.',
	...
	'securepoll-header-ua' => 'Kasutajaagent',
	'securepoll-header-cookie-dup' => 'Topelt',
...
Aukera guztiei 1etik 999ra arteko balio bat eman behar diezu.',
	...
	'securepoll-language-label' => 'Hizkuntza aukeratu:',
...
$messages['fa'] = array(
	...
	'securepoll-not-started' => 'این رأی‌گیری هنوز آغاز نشده‌است.
...
شما باید به همهٔ گزینه‌ها امتیازی بین ۱ تا ۹۹۹ بدهید.',
	...
	'securepoll-not-logged-in' => 'شما باید برای رای‌دادن در این رای‌گیری وارد سامانه شوید.',
	...
	'securepoll-dump-no-crypt' => 'هیچ رکورد رای‌گیری رمزگذاری‌شده‌ای برای این رای‌گیری در دسترس نیست، چرا که رأی‌گیری برای استفاده از رمزگذاری، پیکربندی نشده‌است.',
...
ખેદ છે, તમે આ ચૂંટણીમાં ફરી મતદાન નહીં કરી શકો.',
	'securepoll-change-allowed' => '<strong>નોંધ: તમે આ  ચૂંટનીમાં પહેલાં ભાગ લીધો છે.</strong>
તમે નીચે આપેલ ફોર્મ વાપરીને તમારો મત બદલી શકો છો.
એ વાતની નોંધ લેશો કે જો તમે એમ કરશો તો તમારો આની પહેલાં નો મત રદ્દ થશે.',
...
તમારે દરેક વિકલ્પને ૧ થી ૯૯૯ સુધીનો ક્રમ આપવો જોઈએ',
	...
	'securepoll-remote-auth-error' => 'તમારા ખાતાની માહિતીને સર્વર પરથી લાવવામાં ત્રુટી',
	'securepoll-remote-parse-error' => 'સર્વર તરફથી સત્તાધિકરણ પ્રતિભાવ ઉકેલતી વખતે ક્ષતિ આવી.',
	...
	'securepoll-not-in-list' => 'ખેદ છે, મતદાતા યાદીમાં તમારું નામ નથી. તેમે આ મતદાનમાં ભાગ નહીં લહી શકો.',
	...
	'securepoll-strike-error' => 'છેકો મારવામાં / હટાવવામાં ત્રુટિ: $1',
	...
	'securepoll-dump-no-crypt' => 'આ ચૂંટણી માટે કોઈ પણ એનક્રીપ્ટેડ રેકોર્ડ મોજૂદ નથી, કેમકે ચૂંટણીમાં મત ઍનક્રેપ્ટ કરવાની ગોઠવણ કરવામાં આવી નથી.',
	'securepoll-dump-not-finished' => 'એન્ક્રિપ્ટ ચૂંટણી યાદીઓ માત્ર અંતિમ તારીખ પછી $1 પર $2 સમયે જ પ્રાપ્ત થશે',
	'securepoll-dump-no-urandom' => 'ખોલી /dev/urandom નહીં શકાય. 
મતદાતાની ગુપ્તતા જાળવવા, ઍન્ક્રીપ્ટેડ ચૂંટણી રેકોર્ડજ સાર્વજતિક રીતે ઉપલબ્ધ હોઈ શકે, તેમને રેન્ડમ નંબર સ્ટ્રીમ દ્વારા શફલ કરી શકાય.',
	'securepoll-urandom-not-supported' => 'આ સર્વર ક્રીપ્ટોગ્રાફીક રેન્ડમ નંબર રચનાની સુવિધા ધરાવતું નથી.
મતદાતાની ગુપ્તતા જાળવવા ઍનક્રીપ્ટેડ ચૂંટની રેકોર્ડ સાર્વજનીક ડોમેનમાં ઉપલબ્ધ હોય છે જેમને સીક્યોર્ડ નંબર સ્ટ્રીમ દ્વારા ઉકેલી શકાય છે.',
...
તમે માહિતીસંચની માહિતી અપ્રથી પરિણામ તાળો મેળવી શકો અથવા ચધાવેલી ફાઈલ પરથી ઍનક્રીપ્ટેડ પરિણામો મેળવે શકો છો.',
	...
	'securepoll-tally-error' => 'મતને ઉલેકેલવામાં ત્રુટી, મતદાન નો તાળો  નહીં બનાવી શકાય',
...
आपको सभी विकल्पों को 1 से 999 के बीच में कोई क्रम देना चाहिए।',
	...
	'securepoll-too-new' => 'क्षमा करें, आप मतदान नहीं कर सकते हैं। आपके खाते को $1 के पहले पंजीकृत होने कि आवश्यकता थी, आप $2 को पंजीकृत किये गए थे।', # Fuzzy
	'securepoll-blocked' => 'क्षमा कीजिए, आप इस निर्वाचन में मतदान नहीं कर सकते यदि आप वर्तमान में संपादन करने से बाधित हैं।',
	'securepoll-blocked-centrally' => 'यदि आप पर अवरुद्ध कर रहे हैं खेद है, आप इस चुनाव में वोट नहीं कर सकते $1 या एक से अधिक {{PLURAL:$1| विकि | विकि}}', # Fuzzy
...
Morate dati svim opcijama rang između 1 i 999.',
	...
	'securepoll-too-new' => 'Nažalost, ne možete glasovati. Vaš suradnički račun je morao biti registriran prije $1 za glasovanje na ovim izborima, Vi ste se registrirali $2.', # Fuzzy
	'securepoll-blocked' => 'Nažalost, ne možete glasovati na ovim izborima ako ste trenutačno blokirani',
	'securepoll-blocked-centrally' => 'Nažalost, ne možete glasovati na ovim izborima ako ste blokirani na $1 ili više {{PLURAL:$1| wiki|wikija}}.', # Fuzzy
...
Anda harus memberi peringkat antara 1 dan 99 untuk semua pilihan.',
	...
	'securepoll-blocked-centrally' => 'Maaf, Anda tidak dapat memberikan suara dalam pemilihan ini karena Anda diblokir pada sedikitnya $1 {{PLURAL:$1|wiki|wiki}}.',
...
Masapul nga ikkam amin dagiti pagpilian ti ranggo a nagbaetan ti 1 ken 999.',
	...
	'securepoll-header-details' => 'Dagiti salaysay',
...
Devi assegnare a ciascuna voce un voto compreso tra 1 e 999.',
	...
	'securepoll-remote-auth-error' => 'Errore durante il recupero delle informazioni sulla tua utenza dal server.',
	...
	'securepoll-bot' => 'Spiacente, le utenze con lo status di bot non sono ammesse a votare in questa elezione.',
...
$messages['ja'] = array(
	...
	'securepoll-invalid-page' => '「<nowiki>$1</nowiki>」は無効な下位ページです',
	'securepoll-need-admin' => 'この操作を行うにはあなたが選挙管理者である必要があります。',
	'securepoll-too-few-params' => '下位ページ引数が足りません(リンクが無効です)。',
...
必要であれば、以下の受理証をあなたの投票の証しとして保管しておくことができます。
...
<pre>$2</pre>',
	...
	'securepoll-remote-auth-error' => 'サーバーからあなたのアカウント情報を取得する際にエラーが発生しました。',
	'securepoll-remote-parse-error' => 'サーバーからの認証応答の解釈に失敗しました。',
	'securepoll-api-invalid-params' => 'パラメーターが無効です。',
	'securepoll-api-no-user' => '指定したIDの利用者が見つかりません。',
	'securepoll-api-token-mismatch' => 'セキュリティトークンが一致しないためログインできません。',
	'securepoll-not-logged-in' => 'この投票に参加するためにはログインしていなければいけません',
	'securepoll-too-few-edits' => '申し訳ありませんが、あなたは投票できません。この投票に参加するためには少なくとも$1{{PLURAL:$1|回}}の編集経験が必要です。現在の編集回数は$2です。',
	'securepoll-too-new' => '申し訳ありませんが、あなたは投票できません。この選挙で投票するには、アカウントの登録が $1 $3 より前である必要がありますが、あなたは $2 $4 にアカウント登録しています。',
	'securepoll-blocked' => '申し訳ありませんが、あなたは現在、投稿ブロックされているためこの投票に参加できません。',
	'securepoll-blocked-centrally' => '申し訳ありませんが、少なくとも $1 {{PLURAL:$1|ウィキ}}でブロックされているため、あなたはこの選挙で投票できません。',
	'securepoll-bot' => '申し訳ありませんが、ボットフラグが付いたアカウントはこの選挙で投票することが許可されていません。',
	'securepoll-not-in-group' => '$1グループに属する利用者のみがこの投票に参加できます。',
	'securepoll-not-in-list' => '申し訳ありませんが、あなたはあらかじめ決められた投票メンバーではないためこの投票に参加できません。',
	'securepoll-list-title' => '票を列挙: $1',
	...
	'securepoll-dump-not-finished' => '暗号化された選挙記録は終了日の$1 $2以降のみ入手できます',
...
Kasalahan:
<pre>$2</pre>',
	'securepoll-gpg-config-error' => 'Salah ngatur kunci GPG.',
	'securepoll-gpg-parse-error' => 'Kasalahan napsiraké weton GPG.',
	'securepoll-jump' => 'Parani sasana pamilihan',
	'securepoll-bad-ballot-submission' => 'Swara Sampéyan ora sah: $1',
	'securepoll-unanswered-questions' => 'Sampéyan kudu njawab kabèh pitakon.',
	'securepoll-invalid-score' => 'Skor kudu arupa angka antara $1 lan $2.',
	'securepoll-unanswered-options' => 'Sampéyan kudu ngawèhi wangsulan saka pendhak pitakon.',
	'securepoll-remote-auth-error' => 'Ana kasalahan nalika njupuk informasi akun Sampéyan saka sasana.',
	'securepoll-remote-parse-error' => 'Ana kasalahan napsiraké wangsulan otorisasi saka sasana.',
	'securepoll-api-invalid-params' => 'Paramèter ora sah.',
	'securepoll-api-no-user' => 'Ora ana panganggo mawa ID mangkono.',
	'securepoll-api-token-mismatch' => 'Kodha aman ora cocok, ora bisa mlebu log.',
	'securepoll-not-logged-in' => 'Sampéyan kudu mlebu log kanggo nywara nèng pamilihan iki',
	'securepoll-too-few-edits' => 'Ngapunten, Sampéyan ora bisa nywara. Sampéyan kudu wis nggawé paling ora $1 {{PLURAL:$1|suntingan|suntingan}} kanggo nywara nèng pamilihan iki, Sampéyan nduwéné $2.',
	'securepoll-too-new' => 'Ngapunten, Sampéyan ora bisa nywara. Akun Sampéyan kudu kadaptar sakdurungé $1 wayah $3 kanggo nywara nèng pamilihan iki, Sampéyan ndaptar $2 wayah $4.',
	'securepoll-blocked' => 'Ngapunten, Sampéyan ora bisa ngawèhi swara nèng pamilihan iki yèn Sampéyan lagi diblokir saka nyunting.',
	'securepoll-blocked-centrally' => 'Ngapunten, Sampéyan ora bisa ngawèhi swara nèng pamilihan iki yèn Sampéyan diblokir nèng paling ora $1 {{PLURAL:$1|wiki|wikis}}.',
	'securepoll-bot' => 'Ngapunten, akun mawa tandha bot ora dililakaké ngawèhi swara nèng pamilihan iki.',
	'securepoll-not-in-group' => 'Namung anggota klompok "$1" bisa ngawèhi swara nèng pamilihan iki.',
	'securepoll-not-in-list' => 'Ngapunten, Sampéyan ora kadaptar minangka pamilih sing bisa ngawèhi swara.',
	...
	'securepoll-strike-error' => 'Kasalahan nglakokaké orèkan/mbatalaké orèkan: $1',
	'securepoll-strike-token-mismatch' => 'Data babak ilang',
	'securepoll-details-link' => 'Rincian',
	'securepoll-details-title' => 'Rincian swara: #$1',
	'securepoll-invalid-vote' => '"$1" dudu ID swara sing sah',
	'securepoll-header-voter-type' => 'Jinis panywara',
	'securepoll-voter-properties' => 'Prangkat panywara',
	'securepoll-strike-log' => 'Orèk log',
	'securepoll-header-action' => 'Lelakon',
	'securepoll-header-reason' => 'Alesan',
	'securepoll-header-admin' => 'Pangurus',
	'securepoll-cookie-dup-list' => "''Cookie'' panganggo dobel",
	'securepoll-dump-title' => 'Guwang: $1',
	'securepoll-translate-title' => 'Terjemahaké: $1',
	'securepoll-invalid-language' => 'Kodhe basa ora sah "$1"',
	'securepoll-submit-translate' => 'Anyari',
	'securepoll-language-label' => 'Pilih basa:',
	'securepoll-submit-select-lang' => 'Terjemahaké',
	'securepoll-entry-text' => 'Iki daptar swara.',
	'securepoll-header-title' => 'Jeneng',
	'securepoll-header-start-date' => 'Tanggal lekas',
	'securepoll-header-end-date' => 'Tanggal rampung',
	'securepoll-subpage-vote' => 'Swara',
	'securepoll-subpage-translate' => 'Terjemahaké',
	'securepoll-subpage-list' => 'Daptar',
	'securepoll-subpage-dump' => 'Guwang',
	'securepoll-subpage-tally' => 'Cacahé swara',
	'securepoll-tally-title' => 'Ngétung: $1',
	'securepoll-tally-not-finished' => 'Ngapunten, Sampéyan ora bisa ngétung swara tekan coblosané rampung.',
	'securepoll-tally-local-legend' => 'Ngétung asil kasimpen',
	'securepoll-tally-local-submit' => 'Gawé panyacah swara',
	'securepoll-tally-upload-submit' => 'Gawé panyacah swara',
	'securepoll-no-upload' => 'Ora ana berkas diunggah, ora bisa ngétung asil.',
	'securepoll-ranks' => 'Pringkat pungkasan',
	'securepoll-average-score' => 'Biji reratan',
	'securepoll-round' => 'Babak $1',
	'securepoll-spoilt' => '(Rusak)',
	'securepoll-exhausted' => '(Kesel)',
);
...
모든 선택 사항에 대해 1부터 999까지 순위를 매겨야 합니다.',
	...
	'securepoll-invalid-vote' => '"$1"은 올바른 ID가 아닙니다',
...
Do moß alle Müjjeleschkeite ene Rang zwesche 1 un 999 jevve.',
	...
	'securepoll-header-timestamp' => 'Zigg',
	'securepoll-header-voter-name' => 'Name',
	...
	'securepoll-strike-reason' => 'Aanlaß ov Jrond:',
...
Öm et Wahljeheimnis ze bewaahre, sin de verschößelte Opzeichnunge vun der Stemme bloß dann öffentlich ze han, wann mer se en ene seshere zofällije Reijefollsh zeije künne.',
	...
	'securepoll-submit-select-lang' => 'Övversäze!',
	...
	'securepoll-subpage-vote' => 'Afschtemme',
	'securepoll-subpage-translate' => 'Övversäze',
...
Si fänke viraussiichtlech den $2 ëm $3 un.',
	...
	'securepoll-not-qualified' => 'Dir sidd net qualifizéiert fir bei dëse Walen ofzestëmmen: $1',
	'securepoll-change-disallowed' => 'Dir hutt bei dëse Wale virdru schonn ofgestëmmt.
...
Dir musst allen optiounen e Classement tëscht 1 an 999 ginn.',
	...
	'securepoll-not-logged-in' => 'Dir musst Iech alogge fir bei dëse Walen ofstëmmen ze kënnen',
	'securepoll-too-few-edits' => 'Pardon, Dir däerft net ofstëmmen. Dir musst mindestens $1 {{PLURAL:$1|Ännerung|Ännerunge}} gemaacht hunn, fir bei dëse Walen ofstëmmen ze kënnen, Dir hutt der $2 gemaach.',
	'securepoll-too-new' => 'Pardon, Dir däerft net ofstëmmen. Äre Benotzerkont hätt misse virum $1 ëm $3 registréiert si fir bei dëse Walen ofstëmmen ze däerfen. Dir sidd zënter dem $2 ëm $4 registréiert.',
	'securepoll-blocked' => 'Pardon, Dir kënnt net bei dëse Walen ofstëmmen wann Dir elo fir Ännerunge gespaart sidd.',
	'securepoll-blocked-centrally' => "Pardon, Dir däerft bei dëse Walen net ofstëmme well Dir an op d'mannst $1 {{PLURAL:$1|Wiki|Wikië}} gespaart sidd.",
	'securepoll-bot' => 'Pardon, Benotzerkonte matt engem Bottefändel (bot flag) däerfe bei dëse Walen net ofstëmmen.',
	'securepoll-not-in-group' => 'Nëmme Membere vum Grupp $1 kënne bei dëse Walen ofstëmmen.',
	'securepoll-not-in-list' => 'Pardon, awer Dir stitt op der Lëscht vun de Benotzer déi autoriséiert si fir bei dëse Walen ofzestëmmen.',
...
Dir kënnt wielen tëscht der Auswäertung vun den aktuelle Resultater an der Datebank oder der Auswäertung an engem erofgeluedene Fichier.",
	...
	'securepoll-tally-error' => "Feeler bei der Interpretatioun vun de gespäicherten Donnéeë vun de Walen, d'Auszieleung kann net gemaach ginn.",
...
Visoms parinktims turite skirti įvertinimą tarp 1 ir 999.',
	...
	'securepoll-too-new' => 'Atsiprašome, Jūs negalite balsuoti. Jei norite balsuoti šiuose rinkimuose, Jūsų sąskaita turi būti sukurta iki $1, tačiau Jūsų sąskaita yra sukurta $2.', # Fuzzy
	'securepoll-blocked' => 'Atsiprašome, Jūs negalite balsuoti šiuose rinkimuose jei dabar esate užblokuotas.',
	'securepoll-blocked-centrally' => 'Atsiprašome, Jūs negalite balsuoti šiuose rinkimuose, jei esate blokuotas $1 {{PLURAL:$1|wiki-projekte|wiki-projektuose}} ar daugiau.', # Fuzzy
...
$messages['lv'] = array(
	...
	'securepoll-jump' => 'Doties uz balsošanas serveri',
	'securepoll-bad-ballot-submission' => 'Jūsu balsojums bija nederīgs: $1',
	'securepoll-unanswered-questions' => 'Tev ir jāatbild uz visiem jautājumiem.',
	'securepoll-api-invalid-params' => 'Nederīgi parametri.',
	'securepoll-list-title' => 'Uzskaitīt balsis: $1',
...
На сите избори мора да им доделите ранг помеѓу 1 и 999.',
	...
	'securepoll-header-ua' => 'Кориснички извршител',
...
За да се одржи приватноста на гласачите, шифрираните избирачки податоци стануваат достапни за јавноста само кога ќе можат да се мешаат со безбедна низа случајни броеви.',
	...
	'securepoll-language-label' => 'Одберете јазик:',
	...
	'securepoll-subpage-dump' => 'Склад на гласови',
...
<pre>$1</pre>',
	...
	'securepoll-return' => '$1 -ലേയ്ക്കു മടങ്ങുക',
...
താങ്കൾ 1 മുതൽ 999 വരെയുള്ളതിനിടയ്ക്കുള്ള റാങ്ക് എല്ലാത്തിനും നൽകേണ്ടതാണ്.',
	...
	'securepoll-details-link' => 'വിശദാംശങ്ങൾ',
	...
	'securepoll-header-url' => 'യൂ.ആർ.എൽ.',
...
ഇപ്പോൾ ഡേറ്റാബേസിലുള്ള ഫലങ്ങളുമായി താങ്കൾക്ക് ഒത്തുനോക്കാവുന്നതാണ്, അല്ലെങ്കിൽ അപ്‌‌ലോഡ് ചെയ്യുന്ന ഒരു പ്രമാണത്തിലെ ഗൂഢീകരിക്കപ്പെട്ട ഫലങ്ങൾ ഒത്തുനോക്കാവുന്നതാണ്.',
	...
	'securepoll-strength-matrix' => 'പഥ ശേഷി വൃക്ഷം',
...
$messages['mr'] = array(
	...
	'securepoll-need-admin' => 'हे कार्य करण्यासाठी आपण निवडणूक अधिकारी असणे आवश्यक आहे',
	'securepoll-too-few-params' => 'उपपान पॅरामीटर्स पुरेशा  नाहीत (अग्राह्य दुवा).',
	'securepoll-invalid-election' => '"$1" हे योग्य  निवडणुक ओळखपत्र नाही.',
	...
	'securepoll-finished' => 'निवडणुका संपल्या आहेत.आपण मतदान करू शकत नाही.',
	'securepoll-not-qualified' => 'आपण या निवडणुकीत मत देण्यास पात्र नाहीत:$1',
...
आपण सर्व विकल्पांना १ ते ९९९ मधील गुणानुक्रम द्यावयास हवा.',
	'securepoll-invalid-score' => 'आपले गुण $1 ते $2 या आकड्यादरम्यानच हवेत.',
	...
	'securepoll-api-token-mismatch' => 'सुरक्षा बिल्ला जुळलेला नाही , आपण प्रवेश करू शकत नाही',
	...
	'securepoll-invalid-vote' => '"$1" हे योग्य  निवडणुक ओळखपत्र नाही.',
	'securepoll-header-voter-type' => 'मतदाराचे प्रकार',
	'securepoll-voter-properties' => 'मतदाराचे गुणधर्म',
...
Impossibbli li tiġi deċifrata.",
	...
	'securepoll-invalid-rank' => 'Vot invalidu. Trid tagħti l-kandidati vot bejn 1 u 999.',
	'securepoll-unranked-options' => 'Ċerti għażliet huma nieqsa minn vot. Trid tagħti kull għażla vot bejn 1 u 999.',
	'securepoll-invalid-score' => 'Il-vot irid ikun numru bejn $1 u $2.',
	'securepoll-unanswered-options' => 'Trid twieġeb għal kull mistoqsija.',
	...
	'securepoll-too-new' => "Jiddispjaċina, però ma tistax tivvota. Il-kont tiegħek irid ikun reġistrat bejn $1 fil-$3 sabiex tivvota f'din l-elezzjoni, waqt li inti rreġistrajt fil-$2 fil-$4.",
	'securepoll-blocked' => "Jiddispjaċina, ma tistax tivvota f'din l-elezzjoni jekk inti attwalment imblukkat milli timmodifika.",
	'securepoll-blocked-centrally' => "Jiddispjaċina, ma tistax tivvota f'din l-elezzjoni minħabba li inti mblukkat fuq tal-anqas $1 {{PLURAL:$1|wiki|wikis}}.",
	...
	'securepoll-strike-token-mismatch' => 'L-informazzjoni tas-sessjoni ntilfet',
...
Biex tinżamm il-privatezza tal-votant, ir-reġistrazzjonijieet kriptati tal-elezzjoni huma disponibbli pubblikament biss meta jistgħu jkunu mħawwda b'influss sigur ta' numru każwali.",
	'securepoll-urandom-not-supported' => "Is-server ma jsostnix il-ġenerazzjoni ta' numri każwali għall-kriptografija.
Sabiex tinżamm il-privatezza tal-votant, il-proċedura ta' votazzjoni ċifrata tiġi wżata pubblikament meta jkun disponibbli ġeneratur ta' numri każwali għall-kriptografija tal-influss ta' informazzjoni.",
...
Inti tista' tagħżel jew li tgħodd ir-riżultati preżenti fid-databażi, jew li tgħodd ir-riżultati kriptati minn fajl imtella'.",
	...
	'securepoll-dump-corrupt' => "Il-fajl ta' skariku huwa korrott u ma jistax jiġi pproċessat.",
);
...
$messages['nds'] = array(
	...
	'securepoll-need-admin' => 'Du musst Administrater wesen, dat du dat doon kannst.', # Fuzzy
...
तपाईंले सब विकल्पहरुलाई 1 देखि 999 सम्मको कुनै एउटा स्तर दिनुपर्छ।',
	...
	'securepoll-too-new' => 'माफ गर्नुहोला । तपाईले भोट दिन सक्नुहुन्न।  यस मतदान मा भोट दिनलाई  तपाईको खाता $1 भन्दा पहिले दर्ता गरिएको हुनुपर्छ भने तपाईले $2 मा दर्ता गर्नुभएको थियो।', # Fuzzy
	'securepoll-blocked' => 'माफ गर्नुहोस्, तपाईंले यस चुनावमा मत दिन सक्नुहुन्न। तपाईंलाई सम्पादन गर्न बन्देज गरिएकोछ।',
	'securepoll-blocked-centrally' => 'माफ गर्नुहोला, जब तपाइलाई $1 वा बढि{{PLURAL:$1|विकीi|विकीहरु}}.मा निषेध गरिएको हुन्छ, तपाइले यस चुनावमा तपाईले भोट दिन पाउुनुहुन्न  ।', # Fuzzy
...
Kan ikkje dekryptera.',
	...
	'securepoll-submit-translate' => 'Oppdater',
	'securepoll-language-label' => 'Vel språk:',
...
Vos cal balhar un reng entre 1 e 999 a totas las opcions.",
	...
	'securepoll-too-new' => 'O planhèm, podètz pas votar. Vòstre compte deviá èsser enregistrat abans lo $1 a  $3 per votar per aquesta seleccion, vos sètz enregistrat ​​lo $2 a $4.',
...
Per assegurar la confidencialitat dels votants, las donadas criptadas son publicadas unicament quand pòdon trebolar un flux aleatòri de nombres.',
	...
	'securepoll-subpage-translate' => 'Tradusir',
	'securepoll-subpage-list' => 'Lista',
	'securepoll-subpage-dump' => 'Dump',
...
$messages['ps'] = array(
	...
	'securepoll-need-admin' => 'د دې کړنې د ترسره کولو لپاره تاسې ته پکار ده چې د ټاکنې يو پازوال اوسۍ.',
	...
	'securepoll-details-link' => 'تفصيلات',
...
Deve atribuir a todas as opções uma classificação entre 1 e 999.',
	...
	'securepoll-blocked' => 'Desculpe, mas não pode votar nesta eleição se foi bloqueado de efetuar edições.',
...
Tu a dà a tutte le opziune 'na posizione 'mbrà 1 e 999.",
	...
	'securepoll-too-new' => "Ne despiace, non ge puè vutà. 'U cunde utende tune abbrsogne de essere reggistrate apprime de $1 a le $3 pe vutà jndr'à st'elezione, tu t'è reggistrate 'u $2 a le $4.",
	'securepoll-blocked' => "Ne dispiace, tu non ge puè vutà jndr'à sta elezione purcé tu è state bloccate da fà le cangiaminde.",
	'securepoll-blocked-centrally' => "Ne dispiace, tu non ge puè vutà jndr'à st'elezione purcé è state bloccate almene sus a $1 {{PLURAL:$1|uicchi}}.",
...
Вам необходимо указать ранг от 1 до 999 для всех записей.',
	...
	'securepoll-too-few-edits' => 'Извините, вы не можете проголосовать. Вам необходимо иметь не менее $1 {{PLURAL:$1|правки|правок}} для участия в этом голосовании, а за вами числится $2.',
	...
	'securepoll-blocked-centrally' => 'К сожалению, вы не можете голосовать на этих выборах, так как вы заблокированы по меньшей мере в $1 {{PLURAL:$1|вики}}.',
...
Для обеспечения конфиденциальности избирателей, зашифрованные записи подачи голосов можно делать общедоступными, когда порядок их следования изменён с использованием безопасного источника случайных чисел.',
	'securepoll-urandom-not-supported' => 'Этот сервер не поддерживает криптографическое генерирование случайных чисел.
...
Жебы забеспечіти утаїня голосованя є шіфрованый запис голосованя доступный публіцї лем тогды, коли голосы можуть быти помішаны за помочі жрідла трафунковых чісел.',
	'securepoll-urandom-not-supported' => 'Тот сервер не підпорує кріптоґрафічне ґенерованя трафунковых чісел.
Жебы притаїти голосованя є шіфрованый запис голосованя публічный лем тогды, кідь голосы можуть быти замішаны за помочі безпечного жрідла трафунковых чісел.',
...
क्षम्यताम्, पुनः मतदानं कर्तुम् अवसरः न विद्यते ।',
	'securepoll-change-allowed' => '<strong>टिप्पणी: भवान् अस्मिन् निर्वाचने पूर्वमेव मतदानं कृतवान् ।</strong>
अधः दत्तस्य प्रपत्रस्य दानेन भवतः मतस्य परिवर्तनं कर्तुम् अर्हति ।
ज्ञायतां यत् एवं यदि भवता क्रियेत, तर्हि पूर्वतनं मतं भवति अमान्यम् ।',
	'securepoll-submit' => 'मतदानं क्रियताम्',
	'securepoll-gpg-receipt' => 'मतदानाय धन्यवादः ।
इच्छति चेत्, इदं प्राप्तिपत्रं भवतः मतदानस्य साक्षिरूपेण रक्षितुम् अर्हति :
<pre>$1</pre>',
	'securepoll-thanks' => 'धन्यवादः, भवतः मतं दृढीकृतमस्ति ।',
	'securepoll-return' => '$1 इत्येतद् प्रति निवर्त्यताम्।',
	'securepoll-encrypt-error' => 'भवतः मतं कूटबद्धं कर्तुं न शक्ताः ।
भवतः मतं न दृढीकृतम् !
$1',
	'securepoll-no-gpg-home' => 'GPG गृहप्रणालेः निर्माणे असमर्थम् ।',
	'securepoll-secret-gpg-error' => 'GPG चालने दोषः ।
अधिकविवरणस्य दर्शनाय LocalSettings.php इत्यस्मिन् $wgSecurePollShowErrorDetail=true; इत्यस्य प्रयोगः क्रियताम् ।',
	'securepoll-full-gpg-error' => 'जी पी जी  चालने दोषः :

आदेशः: $1

दोषः :
<pre>$2</pre>',
	'securepoll-gpg-config-error' => 'जी पी जी कुञ्चिकानां विन्यासः दोषयुक्तः ।',
	'securepoll-gpg-parse-error' => 'जी पी जी परिणामस्य विवरणे दोषः ।',
	'securepoll-no-decryption-key' => 'कापि कूटभेदनकुञ्चिका विन्यस्ता नास्ति ।
कूटभेदनं कर्तुम् अशक्यम् ।',
	'securepoll-jump' => 'मतवितरकं प्रति गम्यताम्',
	'securepoll-bad-ballot-submission' => 'भवतः मतम् अमान्यं जातम् : $1',
	'securepoll-unanswered-questions' => 'भवता सर्वेषां प्रश्नानाम् उत्तरं दातव्यम् ।',
	'securepoll-invalid-rank' => 'अमान्य स्थानघोषणम् । १ तः ९९९ पर्यन्तं स्थानघोषणं कर्तव्यम् ।',
	'securepoll-unranked-options' => 'केषाञ्चन विकल्पानां स्थानघोषणं न कृतम् ।
सर्वेषां विकल्पानां कृते १ तः ९९९ पर्यन्तं स्थानघोषणं कर्तुं शक्यते ।',
	'securepoll-invalid-score' => 'भवतः अङ्कः $1  $2 संख्ययोः मध्ये भवेत् ।',
	'securepoll-unanswered-options' => 'सर्वेषां प्रश्नानां कृते प्रतिस्पन्दः दर्शनीयः ।',
	'securepoll-remote-auth-error' => 'वितरकात् भवतः लेखविवरणप्राप्तौ दोषः ।',
	'securepoll-remote-parse-error' => 'वितरकस्य अधिकृतीकरणोत्तरस्य विवरणे दोषः जातः ।',
	'securepoll-api-invalid-params' => 'अपुष्ट प्राचलक।',
	'securepoll-api-no-user' => 'प्रदत्तेन अभिज्ञापकेन युक्तः कोपि योजकः न प्राप्तः ।',
	'securepoll-api-token-mismatch' => 'सुरक्षामुद्रा न दृढीकृता, प्रवेशः न शक्यते ।',
	'securepoll-not-logged-in' => 'अस्मिन् निर्वाचने मतदानाय भवता अन्तः प्रवेशः करणीयः',
	'securepoll-too-few-edits' => 'क्षम्यताम्, भवता मतदानं कर्तुं न शक्यते । अस्मिन् निर्वाचने मतदानं कर्तुं भवता $1 {{PLURAL:$1|सम्पादनम्|सम्पादनानि}} कृतानि स्युः, भवता कृतानि सम्पादनानि $2 ।',
	'securepoll-too-new' => 'क्षम्यताम्, भवता मतदानं कर्तुं न शक्यते । अस्मिन् निर्वाचने मतदानाय भवता $1 दिनाङ्के $3 समयात् पूर्वं भवता पञ्जीकृतं स्यात्, भवता तु $2 दिनाङ्के $4 समये पञ्जीकृतमस्ति ।',
	'securepoll-blocked' => 'क्षम्यताम्, भवता मतदानं कर्तुं न शक्यते यदि भवान् अधुना सम्पादनात् अवरुद्धः ।',
	'securepoll-blocked-centrally' => 'क्षम्यताम्, भवता मतदानं कर्तुं न शक्यते यतः भवान् न्यूनातिन्यूनं $1 {{PLURAL:$1|वीक्यां|वीकीषु}} अवरुद्धः अस्ति ।',
	'securepoll-bot' => 'क्षम्यताम्, बाट्-ध्वजयुक्तलेखावान् अस्मिन् निर्वाचने मतदानं कर्तुं न शक्नुवन्ति ।',
	'securepoll-not-in-group' => '"$1" समूहस्य सदस्याः केवलम् अस्मिन् निर्वाचने मतदानं कर्तुम् अर्हन्ति ।',
	'securepoll-not-in-list' => 'क्षम्यताम्, अस्मिन् निर्वाचने मतदानाय अधिकृतयोजकानां पूर्वनिर्दिष्टायां सूच्यां भवतः नाम न विद्यते ।',
	'securepoll-list-title' => 'मतानां सूची : $1',
	'securepoll-header-timestamp' => 'समय',
	'securepoll-header-voter-name' => 'नाम',
	'securepoll-header-voter-domain' => 'डोमेन',
	'securepoll-header-ua' => 'योजकानुयोज्यः',
	'securepoll-header-cookie-dup' => 'कपटम्',
	'securepoll-header-strike' => 'तिरस्करोतु',
	'securepoll-header-details' => 'विवरणम्',
	'securepoll-strike-button' => 'तिरस्करोतु',
	'securepoll-unstrike-button' => 'अङ्गीकरोतु',
	'securepoll-strike-reason' => 'कारणम् :',
	'securepoll-strike-cancel' => 'निवर्तयते',
	'securepoll-strike-error' => 'तिरस्करणे/अङ्गीकरणे कृतः दोषः : $1',
	'securepoll-strike-token-mismatch' => 'सत्रस्य विवरणं नष्टम्',
	'securepoll-details-link' => 'विवरणम्',
	'securepoll-details-title' => 'मतस्य विवरणम्: #$1',
	'securepoll-invalid-vote' => '"$1" मान्यं मतज्ञापकं नास्ति',
	'securepoll-header-voter-type' => 'मतदातुः प्रकारः',
	'securepoll-voter-properties' => 'मतदातुः गुणधर्मः',
	'securepoll-strike-log' => 'तिरस्कृतप्रणाली',
	'securepoll-header-action' => 'क्रिया',
	'securepoll-header-reason' => 'कारण',
	'securepoll-header-admin' => 'प्रबंधकाः',
	'securepoll-cookie-dup-list' => 'कुकी प्रतिकृतिप्रयोक्ता',
	'securepoll-dump-title' => 'राशिः: $1',
	'securepoll-dump-no-crypt' => 'अस्य निर्वाचनस्य कूटबद्धसङ्ग्रहः न उपलभ्यते, यतः निर्वाचनं कूटबद्धीकरणाय विन्यस्तं न आसीत् ।',
	'securepoll-dump-not-finished' => 'कूटबद्धीकृतः निर्वाचनसङ्ग्रहः $1 दिनाङ्के $2 समयस्य नन्तरमेव उपलभ्यते',
	'securepoll-dump-no-urandom' => '/dev/urandom उद्घाटयितुम् अशक्यम् ।
मतदानिनः वैयक्तिकतायाः रक्षणाय, कूटबद्धं निर्वाचनवृत्तं सार्वजनिकेभ्यः उपलभ्येत । यदा तत् रक्षितसङ्ख्याप्रवाहेण मथितं स्यात् ।',
	'securepoll-urandom-not-supported' => 'अयं वितारकः गूढलेखस्य यादृच्छिकसङ्ख्यायाः उत्पन्ने साहाय्यं न करोति ।
मतदानिनः वैयक्तिकतायाः रक्षणाय, कूटबद्धनिर्वाचनफलितांशः तदा एव सार्वजनिकरूपेण उपलभ्येत् यदा सः यादृच्छिकसङ्ख्याधारया संयोक्तुं शक्येत ।',
	'securepoll-translate-title' => 'अनुवदति: $1',
	'securepoll-invalid-language' => 'अमान्यः भाषाकूटशब्दः "$1"',
	'securepoll-submit-translate' => 'अद्यतनीक्रियताम्',
	'securepoll-language-label' => 'वर भाषा:',
	'securepoll-submit-select-lang' => 'अनुवदति',
	'securepoll-entry-text' => 'अधः मतानां सूची विद्यते ।',
	'securepoll-header-title' => 'नाम',
	'securepoll-header-start-date' => 'प्रारंभ दिनाङ्क',
	'securepoll-header-end-date' => 'समाप्ति दिनाङ्क',
	'securepoll-subpage-vote' => 'मत',
	'securepoll-subpage-translate' => 'अनूद्यताम्',
	'securepoll-subpage-list' => 'सूची',
	'securepoll-subpage-dump' => 'राशीक्रियताम्',
	'securepoll-subpage-tally' => 'तोलनम्',
	'securepoll-tally-title' => 'तोलनम्: $1',
	'securepoll-tally-not-finished' => 'क्षम्यताम्, मतस्थापनस्य समाप्तिं यावत् निर्वाचनस्य तोलनं कर्तुं न शक्यते ।',
	'securepoll-can-decrypt' => 'निर्वाचनफलितांशः कूटबद्धः कृतः अस्ति, किन्तु कूटमुक्तीकरणकुञ्चिका न उपलभ्यते ।
दत्तांशे दत्तेन फलितांशेन सह परिणाममेलनं कर्तुम् अर्हति अथवा उपारोपितायां सञ्चिकायां विद्यमानेन कूटबद्धपरिणामेन सह तोलयितुम् अर्हति ।',
	'securepoll-tally-no-key' => ' भवान् निर्वाचनस्य तोलनं कर्तुं नार्हति यतः मतानि कूटबद्धानि सन्ति किन्तु कूटमुक्तीकरणकुञ्चिका न उपलभ्यते ।',
	'securepoll-tally-local-legend' => 'रक्षितानां फलितांशानां तोलनं क्रियताम्',
	'securepoll-tally-local-submit' => 'तोलनव्यवस्था सज्जीक्रियताम्',
	'securepoll-tally-upload-legend' => 'कूटबद्धीकृतराशिः उपारोप्यताम्',
	'securepoll-tally-upload-submit' => 'तोलनव्यवस्था सज्जीक्रियताम्',
	'securepoll-tally-error' => 'कृतमतस्य विवरणे दोषः, तोलनव्यवस्थां निर्मातुं न शक्यते ।',
	'securepoll-no-upload' => 'न कापि सञ्चिका निवेशिता, फलितांशानां तोलनं कर्तुं न शक्यते ।',
	'securepoll-dump-corrupt' => 'निपाता सञ्चिका दोषयुक्ता, प्रक्रियायोजनम् अशक्यम् ।',
	'securepoll-tally-upload-error' => 'निपातसञ्चिकायाः तोलने दोषः : $1',
	'securepoll-pairwise-victories' => 'युगलविजयसम्पातः',
	'securepoll-strength-matrix' => 'मार्गशक्तिसम्पातः',
	'securepoll-ranks' => 'अन्तिमः क्रमः',
	'securepoll-average-score' => 'माकिं गुणः',
	'securepoll-round' => 'चक्रम् $1',
	'securepoll-spoilt' => '(दुष्टम्)',
	'securepoll-exhausted' => '(समाप्तम्)',
);
...
Musíte dať každej možnosti hodnotenie medzi 1 a 999.',
	...
	'securepoll-blocked-centrally' => 'Ľutujeme, tohoto hlasovania sa nemôžete zúčastniť, pretože ste {{GENDER:|zablokovaný|zablokovaná|zablokovaní}} na minimálne $1 wiki.', # Fuzzy
 ...
 */
$messages['sw'] = array(
	'securepoll-finished' => 'Uchaguzi umekwisha, hauwezi kupiga kura sasa.',
	'securepoll-not-qualified' => 'Haujafuzu kupiga kura katika uchaguzi huu: $1',
	'securepoll-change-disallowed' => 'Umepiga kura katika uchaguzi hu hapo awali.
Pole, hauwezi kupiga kura tena.',
	'securepoll-submit' => 'Wasilisha kura',
	'securepoll-thanks' => 'Asante, kura yako imerekodiwa.',
	'securepoll-return' => 'Rudi kwa $1.',
	'securepoll-jump' => 'Enda wa seva ya kupiga kura',
	'securepoll-bad-ballot-submission' => 'Kura yako ilikuwa batili: $1',
	'securepoll-unanswered-questions' => 'Lazima ujibu maswali yote.',
	'securepoll-header-timestamp' => 'Saa',
	'securepoll-header-voter-name' => 'Jina',
	'securepoll-header-voter-domain' => 'Kikoa',
	'securepoll-header-details' => 'Undani',
	'securepoll-strike-reason' => 'Sababu:',
	'securepoll-strike-cancel' => 'Batilisha',
	'securepoll-details-link' => 'Undani',
	'securepoll-details-title' => 'Maelezo zaidi ya kura: #$1',
	'securepoll-invalid-vote' => '"$1" sio ni ID batili ya kura',
	'securepoll-header-voter-type' => 'Aina ya mpiga kura',
	'securepoll-header-action' => 'Tendo',
	'securepoll-header-reason' => 'Sababu',
	'securepoll-translate-title' => 'Tafsiri: $1',
	'securepoll-submit-translate' => 'Sasisha',
	'securepoll-language-label' => 'Chagua lugha:',
	...
	'securepoll-subpage-vote' => 'Piga kura',
	'securepoll-subpage-translate' => 'Kutafsiri',
	'securepoll-subpage-list' => 'Orodha',
	'securepoll-ranks' => 'Mpangilio wa mwisho',
	'securepoll-average-score' => 'Alama ya wastani',
	'securepoll-spoilt' => '(Zimeharibika)',
);
...
மன்னிக்கவும், மறுமுறை நீங்கள் வாக்களிக்க இயலாது.',
	'securepoll-change-allowed' => '<strong>கவனம்: நீங்கள் இத்தேர்தலில் ஏற்கனவே வாக்களித்துள்ளீர்கள்</strong>
பின்வரும் படிவத்தை நிரப்புவதன் மூலம் உங்கள் வாக்கை நீங்கள் மாற்றலாம்.
இதை நீங்கள் செய்தால் உங்களது பழைய வாக்கு நிராகரிக்கப்பட்டு விடும்.',
	'securepoll-submit' => 'வாக்கை சமர்ப்பிக்கவும்',
	'securepoll-gpg-receipt' => 'வாக்களித்தமைக்கு நன்றி.
...
<pre>$2</pre>',
	...
	'securepoll-jump' => 'வாக்களித்தல் வழங்கிக்குச் செல்லவும்.',
	'securepoll-bad-ballot-submission' => 'உங்கள் வாக்கு செல்லாது: $1',
	'securepoll-unanswered-questions' => 'அவசியம் எல்லா வினாக்களுக்கும் நீங்கள் விடையளிக்க வேண்டும்',
	'securepoll-invalid-rank' => 'தவறான தரவரிசை. வேட்பாளர்களுக்கு 1 முதல் 999 வரையிலான தரவரிசையை மட்டுமே நீங்கள் தரலாம்.',
	'securepoll-unranked-options' => 'சில தேர்வுகளுக்கு நீங்கள் தரவரிசை தரவில்லை.
எல்லா தேர்வுகளுக்கும் நீங்கள் 1 முதல் 999க்கு இடையிலான ஒரு தரவரிசை தந்தாக வேண்டும்.',
	'securepoll-invalid-score' => 'தரவரிசை $1 மற்றும் $2க்கு இடையிலான ஓர் எண்ணாக இருக்க வேண்டும்.',
	'securepoll-unanswered-options' => 'அவசியம் ஒவ்வொரு வினாவுக்கும் பதிலளிக்கவும்.',
	'securepoll-remote-auth-error' => 'உங்கள் கணக்கு விவரங்களை வழங்கியில் இருந்து பெறுவதில் பிழை நேர்ந்துள்ளது.',
	...
	'securepoll-strike-log' => 'அடித்தல் குறிப்பேடு',
	...
	'securepoll-invalid-language' => 'செல்லாத மொழிக்குறியீடு " $1 "',
...
మీరు తప్పనిసరిగా అన్ని వికల్పాలకీ 1 మరియు 999 మధ్యలో ఒక ర్యాంకుని ఇవ్వాలి.',
	...
	'securepoll-remote-auth-error' => 'మీ ఖాతా సమాచారాన్ని సర్వరు నుండి తేవడంలో లోపం జరిగింది.',
	...
	'securepoll-too-new' => 'క్షమించండి, మీరు వోటు వెయ్యలేరు.  ఈ ఎన్నికలో వోటేయడానికి మీ ఖాతా $1 నాడు $3 కంటే ముందు నమోదయి ఉండాలి, మీరు $2 నాడు $4 కి నమోదు చేసుకున్నారు.',
...
Вам слід вказати місця від 1 до 999 для кожного запису.',
	...
	'securepoll-blocked-centrally' => 'На жаль, ви не може голосувати в цих виборах, так як ви заблоковані у $1 {{PLURAL:$1|1=вікіпроекті|вікіпроектах}}.',
...
<pre>$1</pre>',
	...
	'securepoll-unanswered-questions' => 'آپ سب سوالات کا جواب چاہئے.',
	'securepoll-invalid-rank' => 'باطل درجہ بندی. آپ ضروری دے امیدوار 1 اور 999 کے درمیان ایک درجہ بندی.',
	'securepoll-api-invalid-params' => 'باطل پیرامیٹر.',
	'securepoll-not-logged-in' => 'آپ اس انتخاب میں ووٹ میں لاگ ان کرنا ہوگا',
	'securepoll-header-timestamp' => 'وقت',
	'securepoll-header-voter-name' => 'نام',
	'securepoll-header-voter-domain' => 'ڈومین',
	'securepoll-header-ua' => 'صارف کا ایجنٹ',
	'securepoll-header-strike' => 'ہڑتال',
	'securepoll-header-details' => 'تفصیلات',
	'securepoll-strike-reason' => 'وجہ:',
	'securepoll-strike-cancel' => 'منسوخ',
	'securepoll-details-link' => 'تفصیلات',
	'securepoll-voter-properties' => 'یافتہ ووٹر کی خصوصیات',
	'securepoll-strike-log' => 'ہڑتال کے لاگ ان کریں',
	'securepoll-header-action' => 'کارروائی',
	'securepoll-header-reason' => 'وجہ',
	'securepoll-submit-translate' => 'اپ ڈیٹ',
	'securepoll-language-label' => 'زبان کا انتخاب کریں:',
	'securepoll-submit-select-lang' => 'کا ترجمہ',
	'securepoll-header-title' => 'نام',
	'securepoll-header-start-date' => 'تاریخ شروع',
	'securepoll-header-end-date' => 'تاریخ اختتام',
	'securepoll-subpage-vote' => 'ووٹ',
	'securepoll-subpage-translate' => 'کا ترجمہ',
	'securepoll-subpage-list' => 'فہرست',
	'securepoll-tally-upload-legend' => 'خفیہ ڈمپ اپ لوڈ کریں',
	'securepoll-strength-matrix' => 'راہ طاقت میٹرکس',
	'securepoll-ranks' => 'آخری درجہ بندی',
	'securepoll-average-score' => 'اوسط سکور',
);
...
Bạn phải xếp hạng từ 1 đến 999 cho tất cả các ứng viên.',
	...
	'securepoll-too-new' => 'Rất tiếc, bạn không được phép bỏ phiếu. Để được phép tham gia cuộc bầu cử này, bạn cần phải mở tài khoản trước $3 $1, nhưng bạn mới mở tài khoản lúc $4 $2.',
...
$messages['wa'] = array(
	...
	'securepoll-header-ua' => "Adjint d' l' uzeu (''useragent'')",
	'securepoll-header-details' => 'Detays',
	'securepoll-strike-reason' => 'Råjhon:',
	'securepoll-strike-cancel' => 'Rinoncî',
	'securepoll-details-link' => 'Detays',
	'securepoll-details-title' => 'Detays do vôtaedje: #$1',
	'securepoll-header-action' => 'Accion',
	'securepoll-header-reason' => 'Råjhon',
	'securepoll-header-admin' => 'Manaedjeu',
	'securepoll-cookie-dup-list' => 'Uzeus avou des coûkes dedja veyowes',
	'securepoll-language-label' => "Tchoezixhoz l' lingaedje:",
	'securepoll-submit-select-lang' => 'Ratourner',
	'securepoll-entry-text' => "Chal pa dzo l' djivêye des ploncaedjes.",
	'securepoll-header-title' => 'No',
	'securepoll-header-start-date' => 'Date di cmince',
	'securepoll-header-end-date' => 'Date di fén',
	'securepoll-subpage-vote' => 'Vôter',
	'securepoll-subpage-translate' => 'Ratourner',
	'securepoll-subpage-list' => 'Djivêye',
);
...
所有項目都要比一個介於1-999之間的分。',
	...
	'securepoll-too-new' => '對唔住，你唔投得票。$1之前註冊嘅用戶先有資格喺今次選舉投票，而你註冊嘅時間係$2。', # Fuzzy
	'securepoll-blocked' => '對唔住，當你而家被封鎖嗰陣唔可以響呢次選舉度投票。',
	'securepoll-blocked-centrally' => '對唔住啦，你係$1個{{PLURAL:$1|wiki|wikis}}度俾人封咗，所以冇得投票啦。', # Fuzzy
